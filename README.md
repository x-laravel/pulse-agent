...
[![Tests](https://github.com/x-laravel/pulse-agent/actions/workflows/tests.yml/badge.svg)](https://github.com/x-laravel/pulse-agent/actions/workflows/tests.yml)
...
Manual connectivity check (requires a running container with a real `.env`):
